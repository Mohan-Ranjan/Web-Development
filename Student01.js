...
function checkOptions(invoice2){
	...
	switch(invoice2){
		case "java":
			document.getElementById("invoice2").innerHTML = document.getElementById("product1").innerHTML;
			break;

		case "python":
			document.getElementById("invoice2").innerHTML = document.getElementById("product2").innerHTML;
			break;
			
		case "microsoft":
			document.getElementById("invoice2").innerHTML = document.getElementById("product3").innerHTML;
			break;
